...
public class Projects_View extends AppCompatActivity implements View.OnClickListener {

    private TextView edtNama, edtTitle, edtArticle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_projectsview);
        ...
        btnGoUpdate = findViewById(R.id.btn_GoUpdate);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_GoUpdate) {
            Intent intent = new Intent(Projects_View.this, Projects_Edit.class);
            startActivity(intent);
        }
    ...
    public void updateProjects() {
        ...
        if (TextUtils.isEmpty(title)) {
            isEmptyFields = true;
            edtArticle.setError("Please fill this field!g");
        }

        if (! isEmptyFields) {

            Toast.makeText(Projects_View.this, "Updating Data...", Toast.LENGTH_SHORT).show();
    ...
    public void deleteMahasiswa() {
        ...
        Toast.makeText(Projects_View.this, "Deleting data...",
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (isDialogClose) {
                            ...
                            Toast.makeText(Projects_View.this, "Article Deleted",
                                    Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
