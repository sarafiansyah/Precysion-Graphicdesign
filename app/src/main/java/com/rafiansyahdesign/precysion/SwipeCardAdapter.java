...
public class SwipeCardAdapter extends BaseAdapter {
    ...
    private ArrayList<SwipeCard> courseData;
    private Context context;

    // on below line we have created constructor for our variables.
    public SwipeCardAdapter(ArrayList<SwipeCard> courseData, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.swipecard_item, parent, false);
        }
